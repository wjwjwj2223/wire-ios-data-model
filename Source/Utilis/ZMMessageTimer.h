...
/// @param completionBlock The block to be executed when the timer fires. The block is executed in a performBlock of the specified context. The message returned from this block is guaranteed to exist.
